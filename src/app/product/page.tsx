      ...
      <main>
        ...
        <section className="section-darker">
          <div className="section-inner">
            ...
            <h2 className="section-title">Three independent ways a trade fails.</h2>
            ...
            <div className="signal-cards">
              <div className="signal-card">
                ...
                <div>
                  ...
                  <p>Evaluates token contract, liquidity depth, holder distribution, and project credibility before you enter.</p>
                </div>
              </div>
              <div className="signal-card">
                ...
                <div>
                  ...
                  <p>Analyzes price action, volume patterns, and momentum indicators to identify optimal entry points.</p>
                </div>
              </div>
              <div className="signal-card">
                ...
                <div>
                  ...
                  <p>Scores risk based on volatility, liquidity, market structure, and potential catalysts.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="section-darker">
          <div className="section-inner">
            ...
            <h2 className="section-title">The same engine, shaped for the user.</h2>
            <div className="delivery-cards">
              <div className="delivery-card">
                <div className="delivery-card-icon">📊</div>
                <h3>Dashboard</h3>
                <p>Watchlist, signal history, factor explanations. Clear signals for retail traders.</p>
                <a href="/docs">For humans →</a>
              </div>
              <div className="delivery-card">
                <div className="delivery-card-icon">📱</div>
                <h3>Mobile Alerts</h3>
              ...
              <div className="delivery-card">
                <div className="delivery-card-icon">⚡</div>
                <h3>MCP + API</h3>
                <p>Machine-readable queries for agent loops and automated trading systems.</p>
                <a href="/docs">For agents →</a>
              </div>
              <div className="delivery-card">
                <div className="delivery-card-icon">🛡️</div>
                <h3>Guard</h3>
                <p>Session-key deterministic policy. Trades that breach policy revert automatically.</p>
                <a href="/docs">See enforcement →</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section-dark">
          <div className="section-inner">
            ...
            <h2 className="section-title">What can CPAI do?</h2>
            <div className="ai-grid">
              ...
              <div className="ai-card">
                ...
                <h3>Which tokens are trending?</h3>
                <p>Real-time momentum scanner identifies tokens gaining traction before the crowd.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="section-inner">
            <div className="two-col">
              <div>
                ...
                <h2 className="section-title">Sensible questions before trusting a copilot.</h2>
              </div>
        ...
        <section className="section-accent cta-section">
          <div className="section-inner">
            <p className="section-kicker" style={{ color: 'rgba(0,0,0,0.6)' }}>EARLY ACCESS / 2026</p>
